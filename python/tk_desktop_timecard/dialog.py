...
from .management.management_form import ManagementForm
from .management.management_model import ManagementModel
...
class AppDialog(QtGui.QWidget):
    ...
    def createManagementForm(self, UI_filters_action=None):
        """
        Create my task form and facility task form icluding model and view.
        :param UI_filter_action: QAction contains shotgun filter selected in UI
        """
    ...
    def _build_management_model(self, project, UI_filters_action=None):
        """
