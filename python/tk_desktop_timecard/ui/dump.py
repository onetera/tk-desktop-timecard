...
class Ui_DumpDialog(object):
    def setupUi(self, Dialog):
        ...
        self.select_dir.setObjectName("select_excel")
        self.horizontalLayout_2.addWidget(self.select_dir)
        self.load_excel = QtGui.QPushButton(Dialog)
        self.load_excel.setObjectName("load_excel")
        self.horizontalLayout_2.addWidget(self.load_excel)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.load_excel.setText(QtGui.QApplication.translate("Dialog", "Load", None, QtGui.QApplication.UnicodeUTF8))
